...
2. Compare the measured output voltage and phase at resonance to the theoretical
value. Why might these values be different? (Hint: think about source
impedance.)

3. How can the amplitude of the output voltage exceed the amplitude of the input
voltage?