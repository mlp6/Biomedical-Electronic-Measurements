...
<!-- CHANGE: use +12 or +5 V from PSU to reduce number of independent sources -->
...
<!-- TODO: current specs don't need gain b/c of saturation concerns; consider restricting range of bridge to make gain more reasonable to implement -->
...
<!-- TODO: have the students create this reference voltage with a pot, not a separate PSU -->
