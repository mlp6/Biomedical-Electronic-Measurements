...
For the circuit below, determine the power absorbed by the variable resistor
($R$), ranging from 0-20 $\Omega$.  Plot the power absorption as a function of
$R$.  Your plot should be generated "formally" using Python (i.e., not
hand-drawn).  Include your code with your plot.  
