...
* Practical Electronics for Inventors, Paul Scherz and Simon Monk. 3 rd or 4th edition
* [Lessons in Electic Circuits](http://www.ibiblio.org/kuphaldt/electricCircuits/)
...
* Midterm II (TBD)
* LDOC (Dec 05, 2025)
* Final Exam (Lab Practical): Dec 10, 2025 (09:00-12:00)
...
Fundamental knowledge will be assessed with regular online quizzes (~30%).
...
with practical circuit debugging and testing.  Lab exercises will include pre-lab efforts (15%) and post-lab Jupyter notebook submissions of data collection and analysis from the lab exercises (15%).

A final lab practical, held during the final exam period in the lab, will be worth 25%.

There will be two midterm exams, each worth 20%.
